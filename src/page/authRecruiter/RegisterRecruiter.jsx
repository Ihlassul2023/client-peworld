            ...
            <div className="mt-3 mt-md-5 ps-0 ps-md-4">
              ...
              <Form>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control type="text" className="py-3" placeholder="Masukan nama panjang" />
                </Form.Group>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control type="text" className="py-3" placeholder="Masukan nama perusahaan" />
                </Form.Group>
                <Form.Group className="mb-3">
                  <Form.Label>Jabatan</Form.Label>
                  <Form.Control type="text" className="py-3" placeholder="Posisi di perusahaan Anda" />
                </Form.Group>
                <Form.Group className="mb-3">
                  <Form.Label>No handphone</Form.Label>
                  <Form.Control type="number" className="py-3" placeholder="Masukkan no handphone" />
                </Form.Group>
                <Form.Group className="mb-3">
