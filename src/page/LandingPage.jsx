        ...
        <Container>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto gap-4">
              <Button className="custom-btn-outline btn-sm px-3 py-2">
                Masuk Untuk Pekerja
              </Button>
              <Button className="custom-btn btn-sm px-3 py-2">
                Masuk Untuk Pekerja
              </Button>
            </Nav>
          </Navbar.Collapse>
                    ...
                    <Card className="shadow border-0 p-4 m-3">
                      <div className="d-flex flex-column align-items-center text-center">
                        ...
                        <p className="text-black fw-light">
                          ...
                          elit. Corporis sapiente a dignissimos voluptate,
                          mollitia eveniet voluptatem molestias. Provident,
                          facilis aliquam.
                        </p>
                      </div>
                      <Card.Body></Card.Body>
